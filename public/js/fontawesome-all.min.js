...
!function () {
    ...
    var s = t[z], r = Object.assign || function (c) {
    ...
    var e = (l.navigator || {}).userAgent, a = void 0 === e ? "" : e, m = l, t = h, s = v, r = z, f = !!m.document,
        M = !!t.documentElement && !!t.head && "function" == typeof t.addEventListener && "function" == typeof t.createElement,
        i = ~a.indexOf("MSIE") || ~a.indexOf("Trident/"), n = "___FONT_AWESOME___", H = 16, o = "svg-inline--fa",
        V = "data-fa-i2svg", C = "data-fa-pseudo-element", L = "fontawesome-i2svg", u = function () {
            try {
                return !0
            } catch (c) {
                return !1
    ...
    var Q = {x: 0, y: 0, width: "100%", height: "100%"}, Z = function (c) {
        var l = c.children, h = c.attributes, v = c.main, z = c.mask, e = c.transform, a = v.width, m = v.icon,
            t = z.width, s = z.icon, r = J({transform: e, containerWidth: t, iconWidth: a}),
            f = {tag: "rect", attributes: k({}, Q, {fill: "white"})}, M = {
                tag: "g",
                attributes: k({}, r.inner),
                children: [{tag: "path", attributes: k({}, m.attributes, r.path, {fill: "black"})}]
            }, i = {tag: "g", attributes: k({}, r.outer), children: [M]}, n = "mask-" + B(), H = "clip-" + B(), o = {
                tag: "defs",
                children: [{tag: "clipPath", attributes: {id: H}, children: [s]}, {
                    tag: "mask",
        ...
        if (G(a) && h.found && !v.found) {
            ...
            z.style = K(k({}, e, {"transform-origin": m + a.x / 16 + "em " + (t + a.y / 16) + "em"}))
        }
    ...
    function hc(c) {
        var l = c.icons, h = l.main, v = l.mask, z = c.prefix, e = c.iconName, a = c.transform, m = c.symbol,
            t = c.title, s = c.extra, r = c.watchable, f = void 0 !== r && r, M = v.found ? v : h, i = M.width,
            n = M.height, H = "fa-w-" + Math.ceil(i / n * 16),
            o = [O.replacementClass, e ? O.familyPrefix + "-" + e : "", H].concat(s.classes).join(" "), C = {
                children: [],
        ...
        var L = k({}, C, {prefix: z, iconName: e, main: h, mask: v, transform: a, symbol: m, styles: s.styles}),
    ...
    function vc(c) {
        var l = c.content, h = c.width, v = c.height, z = c.transform, e = c.title, a = c.extra, m = c.watchable,
            t = void 0 !== m && m, s = k({}, a.attributes, e ? {title: e} : {}, {class: a.classes.join(" ")});
        t && (s[V] = "");
        ...
        var g = [];
        return g.push({tag: "span", attributes: s, children: [l]}), e && g.push({
            tag: "span",
    ...
    var zc = function () {
        }, ec = O.measurePerformance && r && r.mark && r.measure ? r : {mark: zc, measure: zc}, ac = 'FA "5.0.6"',
        mc = function (c) {
            ...
            var z, e, a, m, t, s = Object.keys(c), r = s.length, f = void 0 !== v ? (m = l, t = v, function (c, l, h, v) {
                return m.call(t, c, l, h, v)
            }) : l;
            for (void 0 === h ? (z = 1, a = c[s[0]]) : (z = 0, a = h); z < r; z++) a = f(a, c[e = s[z]], e, c);
            return a
        }, rc = E.styles, fc = E.shims, Mc = {}, ic = {}, nc = {}, Hc = function () {
            var c = function (c) {
    ...
    function gc(c, l) {
        ...
        0 === c.length ? h() : (m.requestAnimationFrame || function (c) {
            ...
            var l = !0 === O.autoReplaceSvg ? bc.replace : bc[O.autoReplaceSvg] || bc.replace, v = tc.begin("mutate");
            c.map(l), v(), h()
        })
    }
    ...
    var kc = function (c) {
        var l, h, v, z, e = c.getAttribute("data-prefix"), a = c.getAttribute("data-icon"),
            m = void 0 !== c.innerText ? c.innerText.trim() : "", t = Cc(X(c));
    ...
    var Nc = {fill: "currentColor"}, Ec = {attributeType: "XML", repeatCount: "indefinite", dur: "2s"}, Pc = {
            ...
            children: [Pc, {
                ...
                children: [{
                    tag: "animate",
                    attributes: k({}, Ec, {attributeName: "r", values: "28;14;28;28;14;28;"})
                }, {tag: "animate", attributes: k({}, _c, {values: "1;0;1;1;0;1;"})}]
            }, {
                tag: "path",
                attributes: k({}, Nc, {
                    opacity: "1",
                ...
                children: [{tag: "animate", attributes: k({}, _c, {values: "1;0;0;0;0;1;"})}]
            }, {
                tag: "path",
                attributes: k({}, Nc, {
                    opacity: "0",
                ...
                children: [{tag: "animate", attributes: k({}, _c, {values: "0;0;1;1;0;0;"})}]
            }]
        }, Fc = E.styles, Ic = "fa-layers-text", Rc = /Font Awesome 5 (Solid|Regular|Light|Brands)/,
    ...
    function Dc(c) {
        var l, h, v, z, e, a, m, t, s, r, f, M, n, H, o, V, C, L, u,
            d = (h = kc(l = c), v = h.iconName, z = h.prefix, e = h.rest, a = wc(l), m = xc(l), t = Ac(l), s = qc(l), r = Oc(l), {
                iconName: v,
        ...
        return ~d.extra.classes.indexOf(Ic) ? function (c, l) {
            ...
            }, prefix: o, iconName: n, transform: V, symbol: C, mask: L, title: H, extra: u, watchable: !0
        })])
    }
            ...
            yc = !0, function () {
                D(c.querySelectorAll("*")).forEach(function (c) {
                    [":before", ":after"].forEach(function (l) {
                        var h = m.getComputedStyle(c, l), v = h.getPropertyValue("font-family").match(Rc),
    ...
    function Uc(c) {
        ...
        if (M) {
            var h = t.documentElement.classList, v = function (c) {
                ...
                return h.remove(L + "-" + c)
            }, e = Object.keys(Fc), a = ["." + Ic + ":not([" + V + "])"].concat(e.map(function (c) {
                return "." + c + ":not([" + V + "])"
            })).join(", ");
            if (0 !== a.length) {
                ...
                if (m.length > 0) {
                    ...
                    var s = tc.begin("onTree"), r = m.reduce(function (c, l) {
                        try {
                            var h = Dc(l);
                            h && c.push(h)
                        } catch (c) {
    ...
    function Kc(c) {
        var l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, h = Dc(c);
        h && gc([h], l)
    }

    var Gc = function () {
        var c = o, l = O.familyPrefix, h = O.replacementClass,
    ...
    var ll, hl = new (function () {
        ...
        var l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, h = l.transform,
            ...
            t = l.title, s = void 0 === t ? null : t, r = l.classes, f = void 0 === r ? [] : r, M = l.attributes,
        ...
        if (c) {
            ...
            return $c(k({type: "icon"}, c), function () {
                return Zc(), O.autoA11y && (s ? i["aria-labelledby"] = O.replacementClass + "-title-" + B() : i["aria-hidden"] = "true"), hc({
                    icons: {
                        main: Jc(C),
                        mask: m ? Jc(m.icon) : {found: !1, width: null, height: null, icon: {}}
                    },
                    prefix: o,
                    iconName: V,
                    transform: k({}, I, v),
        ...
        var l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            h = (c || {}).icon ? c : cl(c || {}), v = l.mask;
        return v && (v = (v || {}).icon ? v : cl(v || {})), ll(h, k({}, l, {mask: v}))
    }), zl = {
        noAuto: function () {
            var c;
            ...
            i2svg: function () {
                ...
                if (M) {
                    Zc();
                    var l = c.node, h = void 0 === l ? t : l, v = c.callback, z = void 0 === v ? function () {
                    } : v;
                    O.searchPseudoElements && Yc(h), Uc(h, z)
                }
            }, css: Gc, insertCss: function () {
                R(Gc())
            }
        }, library: hl, parse: {
        ...
        }, findIconDefinition: cl, icon: vl, text: function (c) {
            var l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, h = l.transform,
                v = void 0 === h ? I : h, z = l.title, e = void 0 === z ? null : z, a = l.classes,
                m = void 0 === a ? [] : a, t = l.attributes, s = void 0 === t ? {} : t, r = l.styles,
                f = void 0 === r ? {} : r;
            return $c({type: "text", content: c}, function () {
                return Zc(), vc({
                    ...
                    transform: k({}, I, v),
                    title: e,
                    extra: {attributes: s, styles: f, classes: [O.familyPrefix + "-layers-text"].concat(S(m))}
                })
            })
        }, layer: function (c) {
    ...
    Object.defineProperty(zl, "config", {
        ...
        f && (m.FontAwesome || (m.FontAwesome = zl), T(function () {
            Object.keys(E.styles).length > 0 && el(), O.observeMutations && "function" == typeof MutationObserver && function (c) {
                if (s) {
                    var l = c.treeCallback, h = c.nodeCallback, v = c.pseudoElementsCallback, z = new s(function (c) {
            ...
            }({treeCallback: Uc, nodeCallback: Kc, pseudoElementsCallback: Yc})
        })), E.hooks = k({}, E.hooks, {
